...
<title>${query} - 商品搜索 - 宜立方</title>
<meta name="Keywords" content="java,宜立方java" />
<meta name="description" content="在宜立方中找到了${totalRecords }件java的类似商品，其中包含了“图书”，“电子书”，“教育音像”，“骑行运动”等类型的java的商品。" />
...
<li class="item-book" bookid="11078102">
	<div class="p-img">
		<a target="_blank" href="www.taotaomall.com/item/${item.id }.html">
	...
	<div class="service">由 宜立方 发货</div>
	<div class="extra">
